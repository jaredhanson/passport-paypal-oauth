...
//   have a database of user records, the complete PayPal profile is serialized
//   and deserialized.
...
// Use the PayPalStrategy within Passport.
//   Strategies in Passport require a `verify` function, which accept
//   credentials (in this case, an accessToken, refreshToken, and PayPal
//   profile), and invoke a callback with a user object.
passport.use(new PayPalStrategy({
    clientID: PAYPAL_APP_ID,
    clientSecret: PAYPAL_APP_SECRET,
    callbackURL: "https://example.com:3000/auth/paypal/callback"
  },
